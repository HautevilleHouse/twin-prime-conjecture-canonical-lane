...
mkdir -p .tmp/tp_closure
cp artifacts/stitch_constants.json .tmp/tp_closure/stitch_constants.json
cp artifacts/constants_registry.json .tmp/tp_closure/constants_registry.json
